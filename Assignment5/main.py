    ...
    while True:
        try:
            ...
            if user == 0:  # USER
                ...
                print("12. Add Instructor")
                print("13. Remove Instructor")
                print("14. Add Admin")
                print("15. Remove Admin")
                print("16. Query Users")
                print("17. Query Students")
                print("18. Query Instructors")
                print("19. Query Admins")
